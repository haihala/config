...
-- magick_cli processor shells out to the ImageMagick CLI (`magick`, `identify`,
-- `convert`), which is pulled in transitively by `ImageMagick-devel` in
-- dnf_install.sh. No luarock needed.
require("image").setup({
	backend = "kitty",
